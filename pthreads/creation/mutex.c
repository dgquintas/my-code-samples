 ...
 *through a globally accessible structure. Each thread works on a different part
...
int main(int argc, char *argv[]) {
    ...
    /* Obviously, we don't need a mutex at this point because all the threads
     * have finished (after-join) */
    printf("Sum =  %f \n", dotstr.sum);
    free(a);
    free(b);
    /* XXX */
