...

{
 ...
 // put optmized code here
 
 // get local ids, group ids
 
 // calculate the starting index of the global array for the each sub matrix
 
 // iterate each group
	// declare sub matrices in local memory
	// read data from global memory to local memory
	// wait for all work-items int the group to finish copying
	// multiply the sub matrices from local memory and store into accumulator sum
	
 // copy final sum into global memory
