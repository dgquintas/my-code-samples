...
int main() {
        ...
        l = libnet_init(LIBNET_RAW4, "en1", errbuf);
        if ( l == NULL ) {
        ...
        icmp_tag = libnet_build_icmpv4_echo(ICMP_ECHO, //type of icmp packet
                0, // code (must be 0)
        ...
        ip_tag = libnet_autobuild_ipv4(LIBNET_IPV4_H + LIBNET_ICMPV4_ECHO_H, //total len of ip packet including all subsequent data
        ...
        for ( i = 0; i < 4; i++ ) {
                ...
                //note the use of "icmp_tag" as the ptag argument
